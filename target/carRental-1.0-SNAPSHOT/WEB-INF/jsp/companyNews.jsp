...
<%
    ...
    Iterator ita = news.iterator();
    int count = Integer.parseInt(String.valueOf(request.getAttribute("count"))) / 15 + 1;
%>
<html>
<head>
    <title>公司新闻</title>
...
<div id="wrapper">
    ...
    <div id="body" class="clearfix">
        ...
        <div id="main">
            <img src="${path}/Images/image114.jpg" style="margin-top: 15px;"/>
            <div>
                <%
                    while(ita.hasNext()){
                        News ob = (News) ita.next();
                        String title = ob.getTitle();
                        String time = ob.getDate();
                %>
                <div style="width:700px; margin-top: 20px;">
                    <img src="${path}/Images/image115.jpg" style="float:left; margin-top: 2px;"/>
                    <a href="${path}/newsShow.html?id=<%=ob.getId()%>"><span style="float: left; margin-left: 10px;"><%=title%></span></a>
            ...
            <div style="text-align: center; margin-top: 30px; ">
                <div style="margin:0 auto">
                    ...
                    %>
                    <a href="${path}/companyNews.html?pageIndex=<%=i+1%>" style="color: black;"><%=i+1%>&nbsp</a>
                     <%
                        }
                    %>
                </div>
