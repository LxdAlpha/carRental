...
<head>
    ...
    <style>
        ...
        #body{ width: 1020px;  margin: 0 auto; min-height: 900px;}
        #aside{ float: left; width: 240px; height: 900px; }
        #main{ float: left; width: 780px;  min-height: 900px;}
...
<div id="wrapper">
    ...
    <div id="body" class="clearfix">
        ...
        <div id="main">
            <div>
                <img src="${path}/Images/image116.jpg" style="margin-top: 15px;">
                <div style="text-align: center; margin-top: 40px;">
                    <span style="font-size: 120%; font-weight: bold;"><%=news.getTitle()%></span>
                </div>
                <div style="text-align: center; margin-top: 10px;">
                    <%=news.getDate()%>
                </div>
                <div style="margin: 0 auto; width: 700px; margin-top: 40px;"><%=news.getContent()%></div>
            </div>
        </div>
        <div id="footer">
