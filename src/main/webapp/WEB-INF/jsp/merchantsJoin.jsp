    ...
    <div class="panel panel-default" id="merchantsJoin1">
        ...
        <div  id="merchantsJoin3">
            <form name="form1" method="post" action="${path}/merchantsJoinOp.html">
                <table>
                    <tr><td  style="padding-top: 20px;"><span>主　　题：</span></td><td><input size="55" style="margin-top: 20px;" name="theme"></td></tr>
                    <tr><td class="merchantsJoin5"><span>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</span></td><td><input size="23" class="merchantsJoin4" name="name"></td></tr>
                    <tr><td class="merchantsJoin5"><span>公司名称：</span></td><td><input size="23"  class="merchantsJoin4" name="companyName"></td></tr>
                    <tr><td class="merchantsJoin5"><span>联系电话： </span></td><td><input input size="54"  class="merchantsJoin4" name="phone"></td></tr>
                    <tr><td class="merchantsJoin5"><span>手机号码：</span></td><td><input input size="53"  class="merchantsJoin4" name="mobilePhone"></td></tr>
                    <tr><td class="merchantsJoin5"><span>联系邮箱：</span></td><td><input input size="52"  class="merchantsJoin4" name="email"></td></tr>
                    <tr><td class="merchantsJoin5"><span>Q Q号码：</span></td><td><input input size="51"  class="merchantsJoin4" name="qq"></td></tr>
                    <tr><td class="merchantsJoin5"><span>内      容：</span></td><td><textarea   rows="4" cols="50" class="merchantsJoin4" name="content"></textarea></td></tr>
                    <tr><td></td><td><input type="submit" value="提交留言" style="margin-top: 20px; margin-left: 140px;"></td></tr>
                </table>
            </form>
        </div>
    </div>
