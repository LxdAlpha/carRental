        ...
        <div id="main">
            ...
            <div>
                ...
                <div style="width:700px; margin-top: 20px;">
                    ...
                    <a href="${path}/newsShow.html?id=<%=ob.getId()%>">
                        <span style="float: left; margin-left: 10px;"><%=title%></span>
                    </a>
            ...
            <div style="text-align: center; margin-top: 30px; ">
                <div style="margin:0 auto">
                    ...
                    %>
                    <a href="${path}/industryNews.html?pageIndex=<%=i+1%>" style="color: black;"><%=i+1%>&nbsp</a>
                    <%
                        }
                    %>
                </div>
